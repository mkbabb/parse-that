...
export declare function createParserContext<T = any>(name: (typeof parserNames)[number], parser: Parser<T>, ...args: any[]): {
    name: "string" | "eof" | "regex" | "many" | "skip" | "next" | "then" | "or" | "chain" | "map" | "lazy" | "memoize" | "mergeMemo" | "not" | "trim" | "trimWhitespace" | "whitespace" | "wrap" | "sepBy" | "any" | "all" | "opt" | "lookAhead" | "lookBehind" | "regexConcat" | "regexWrap" | "debug";
    parser: Parser<T>;
    args: any[];
};
