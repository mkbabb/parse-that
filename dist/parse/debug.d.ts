...
export declare function statePrint(state: ParserState<any>, name?: string, parserString?: string): string;
export declare function parserDebug<T>(parser: Parser<T>, name?: string, recursivePrint?: boolean, logger?: (...s: any[]) => void): any;
