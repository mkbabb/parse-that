...
`);
        ...
        function Yu(C) {
          if (typeof C != "string" || C.length === 0 || (C = Ju(C), C.length === 0))
            return 0;
...
function nD(s, u = "", e = !1, r = console.log) {
  const i = (n) => {
    const B = s.parser(n), m = e ? Lu(s) : s.context.name, I = Mu(B, u, m);
    return r(I), B;
  };
...
function pu(s, u = "", e) {
  const r = s.map((B) => `(${sD(B)})`).join(u), i = new RegExp(r), n = Ru(i, e);
...
function Ru(s, u = (e) => e == null ? void 0 : e[0]) {
