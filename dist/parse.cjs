...
function assembleStyles() {
  ...
  for (const [groupName, group2] of Object.entries(styles$1)) {
    for (const [styleName, style] of Object.entries(group2)) {
      styles$1[styleName] = {
        open: `\x1B[${style[0]}m`,
        close: `\x1B[${style[1]}m`
      };
      group2[styleName] = styles$1[styleName];
...
const tty = {};
function hasFlag(flag, argv = globalThis.Deno ? globalThis.Deno.args : tty.argv) {
...
function _supportsColor(haveStream, { streamIsTTY, sniffFlags = true } = {}) {
  ...
  if (tty.platform === "win32") {
    const osRelease = tty.release().split(".");
...
exports.any = any;
exports.eof = eof;
exports.getLazyParser = getLazyParser;
exports.lazy = lazy;
exports.mergeErrorState = mergeErrorState;
exports.regex = regex;
