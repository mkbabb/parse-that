...
const SMALLEST_POWER_OF_FIVE: i32 = -342;
...
// --- Core Eisel-Lemire algorithm (from fast_float2::binary) ---

/// Returns (mantissa, power2). power2 == -1 means ambiguous.
#[inline]
fn compute_float(q: i64, mut w: u64) -> (u64, i32) {
...
// --- Power-of-5 table (651 entries, from fast_float2) ---

const N_POWERS_OF_FIVE: usize = 651;
