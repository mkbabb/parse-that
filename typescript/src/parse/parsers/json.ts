/**
 * Combinator JSON parser — built from parse-that primitives.
 * Uses dispatch() for O(1) first-char branching.
 */
...
/** Combinator JSON parser with leading/trailing whitespace trimming. */
