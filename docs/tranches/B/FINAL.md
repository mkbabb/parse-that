...
| Performance-law L1 / L2 / L3 | `OPEN` | L1 family research/common synthesis remain historical inputs. Original Luna `980d7781…` is false-green; performance-law A1 is terminal born-RED. N1-A4/prior-art authority is committed at `81b2a0a`. N2-F0/N2a are terminal mechanics RED, N2b is terminal scientific-runner RED, and N2c/N2d are terminal source-review RED. Paper v1–v3 and paired fresh reviews are immutable zero-credit evidence; v3 A3/B3 are terminal AMEND/RED. V4 and N2e source/execution are withheld pending owner/root ruling. L2/L3 remain blocked. |
| Novelty N1 / N2 / N3 | `N1-A/A1/A2/A3 IMMUTABLE; N1-A4 COMMITTED; N2-F0/N2A TERMINAL MECHANICS RED; N2B TERMINAL SCIENTIFIC-RUNNER RED; N2C/N2D TERMINAL SOURCE_REVIEW_RED; PAPER V1–V3 + REVIEWS IMMUTABLE; V3 A3/B3 TERMINAL AMEND/RED; V4/N2E WITHHELD; N3 BLOCKED` | N1-A through A3 are immutable false-green chronology. N1-A4 closes byte authority and passes its fresh audit. Broad N-IETM novelty folds to prior art. N2-F0 failed package resolution; N2a split coordinates; N2b crashed before timing; N2c failed caller-authored trust boundaries; N2d failed ledger/root/relocation and independent contract planes. Paper v3 is structurally bounded but A3 rejects disconnected P6 production leaves and B3 rejects unbound effect-epoch selection; candidate execution, coordinate-bearing semantic graphs, P5 outer authority, hostile collateral, and P7 own-reason ordering also remain RED. No v4, further review, or N2e source is authorized before a later owner/root ruling. N-DNF-BIR and N-CBLC remain banked/undispatched; N-WRR is born-RED; N-GLL is fatal-only. |
...
JSON rows, and its 432 CSS rows exercised none of them. P5 owner evidence
`0bc0d37` verifies Luna manifest `e2d8fb3e…`, corrects the legacy-signature
premise, and executably kills both one-executor EUW clean breaks: cursor
0.6076–0.7527×, same-state 0.6149–0.7001× across 14 unique processes. P6
...
native. A1's 0.8716–1.0327× raw rows are also inadmissible. A2 owner evidence
...
`PROGRESS.md §Next formation boundary — paper only`, then
...
frozen mechanics evidence. N2b is also terminal: its preflight passed, but its
scientific runner crashed before timing and static review found hardcoded
gates, absent transition authority, incomplete relocation, and lossy product
equality. Preserve its exact 15-file root. N2c is also terminal: its exact
two-file source packet fails first on unproved owner-issued version lineage and
independently on production suppression, caller decoders/hashes, empty raw
closure, relocation/product joins, M2/effects, hostile controls, comparator,
and machine/prose join. Preserve it unexecuted. N2d is also terminal: its exact
two-file source packet fails first on an unbound owner version-ledger root and
vacuous one-version relocation, with independent declaration, canonical
decoder, coordinate/product, effect, hostile-control, M2, and source/prose
defects. Preserve it unexecuted. Do not resume the Luna task or create N2e.
The next formation work is paper only: eight separately hashable interfaces,
two independent paper reviews, then owner agglomeration. No source or review
was dispatched by the ruling. Do not begin product source, CSS implementation,
