...
| Runtime correctness | `IN_PROGRESS` | M2 banked; M3 rejected; S7 locally proves terminal/sequence and generic recovery; recursion, unordered and CSS-needed leaves remain open |
| Full-subject P1→P2→P3 | `IN_PROGRESS` | P1 research banked; later full-subject passes remain open |
| Isolated every-scale/result proof | `RED` | S7 clears terminal/sequence and generic recovery at 96 and 753 names; recursion, unordered, CSS-leaf, Value-owned stylesheet recovery and live-consumer planes remain open |
...
| Allocation/deopt/GC sealed proof | `IN_PROGRESS` | S7 terminal/sequence/recovery CPU, hot-loop, GC/deopt and IC evidence banked; remaining subjects and consumers unsealed |
...
The latest prototype evidence, S7, is banked at `20b5f52`; its run-owned
state, immutable diagnostic collection and terminal/sequence/generic-recovery
evidence are HELD and locally green without formation credit. S6 is banked at
`062c147`, S5 at `926a3ad`, S4 at `75b76dd`, and `2fc18dc` owns the preceding
...
`data` symlink. Resume with S7 bounded recursion, unordered composition and
generic CSS-needed leaf proof. Do not publish, widen the API or begin
Value-owned CSS work from this repository.
