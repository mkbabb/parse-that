...
|---|---|---|
| Canonical parent/PROGRESS/wave/coordination/FINAL | `IN_PROGRESS` | P4 is owner-adjudicated `REJECT/FOLD`; P5-EUW is `KILL/PRUNE`; P6-SIR is the next isolated fatal assay; this ledger remains open |
| Runtime correctness | `IN_PROGRESS` | M2 is the accepted control; live production remains rejected M3. Transaction/run-state/slot/span/recovery/result laws and shaped fixtures are correctness-green; every P1–P5 implementation family is retired and no candidate exists |
...
0.6076–0.7527×, same-state 0.6149–0.7001× across 14 unique processes. P6-SIR
isolates the only unimplemented scalar signed-return observation without
RSR's region/finalizer machinery. No P4/P5/P6 evidence grants formation
credit.
...
grounds. Run only P6-SIR's exact-M2 scale-4 raw fatal cell before broader
work. Do not run formation clean audits, pack a candidate,
