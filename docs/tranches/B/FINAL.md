...
| Performance-law L1 / L2 / L3 | `OPEN` | L1 family research and common synthesis are sealed. Original Luna manifest `980d7781…` has exact neutral arithmetic, but fresh-Sol manifest `3cd94fee…` proves its semantic/sentinel/generic-executor terminal false-green. Correction-only A1 is active and unsealed; owner pre-seal review binds six further cold-boundary, roster, ordinal, cost, provenance and recovery corrections. L2/L3 are blocked. |
